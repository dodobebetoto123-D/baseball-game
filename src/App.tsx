...
const players: Player[] = [
  { id: 1, name: '마일로 레이스', pos: 'CF', role: '???? ???', ovr: 86, form: '뜼거움', color: '#ff9b6a' },
  { id: 2, name: '주노 박', pos: 'SS', role: '?? ??', ovr: 91, form: '??', color: '#d9b3ff' },
  { id: 3, name: '올리 녹스', pos: '1B', role: '?? ??', ovr: 88, form: '안정적', color: '#84dbca' },
  { id: 4, name: '테스 모건', pos: 'RF', role: '? ??', ovr: 83, form: '상승세', color: '#f4d06f' },
  { id: 5, name: 'Cam Ellis', pos: '2B', role: '?? ??', ovr: 80, form: '안정적', color: '#9db7ff' },
  { id: 6, name: 'Nia Valdez', pos: 'C', role: '?? ???', ovr: 84, form: '뜼거움', color: '#ffb3c6' },
  { id: 7, name: 'Rafi Cole', pos: 'LF', role: '?? ???', ovr: 78, form: '하락세', color: '#b9e4a0' },
  { id: 8, name: 'Beck Harlow', pos: '3B', role: '?? ???', ovr: 76, form: '상승세', color: '#ffc48a' },
]
...
function App() {
  ...
  const playAtBat = () => {
    const outcomes = ['???? ???? ??? 2??!', 'Juno turns on a fastball — gone!', '???? ????? ??? ??????.', '??? ???? ??? ?????.', '??? ?? ??? ?? ??? ?????.']
